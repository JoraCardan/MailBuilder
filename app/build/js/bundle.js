...
var MailBuilder = function () {
    ...
    this.SELECTORS = {
      ...
      editors: {
        ...
        editor: {
          ...
          schema: 'html5-strict',
          // Context options
          contextmenu: 'paste copy link unlink bold italic underline striketh' + 'rough removeformat sub sup',
          ...
          toolbar: 'undo redo format forecolor backcolor hr link unlink bulli' + 'st numlist paste bold italic underline strikethrough justi' + 'fyleft justifycenter justifyfull'
        },
        logo: {
  ...
  _createClass(MailBuilder, [{
    ...
    value: function initPlugins() {
      var options = this.SELECTORS.editors;

      _lodash2.default.forOwn(options, function (configuration) {
    ...
    value: function parseHTML() {
      var regex = this.macros.regex;
      var app = this.SELECTORS.app;
      var self = this;
      var html = app.html();
      var found = void 0,
          replacement = void 0;
...
(0, _jquery2.default)(document).ready(function () {
  var mailApp = new MailBuilder();
});

},{"./components/macro":1,"jquery":3,"lodash":4}],3:[function(require,module,exports){
/*!
